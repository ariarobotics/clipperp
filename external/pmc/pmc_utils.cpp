...
double get_time() {
    ...
    return static_cast<double>(t.tv_sec)*1.0 + static_cast<double>(t.tv_usec)/1000000.0;
}
...
void print_max_clique(const vector<int>& C) {
...
void print_n_maxcliques(const set<vector<int>>& C, int n) {
#ifdef PMC_ENABLE_DEBUG
